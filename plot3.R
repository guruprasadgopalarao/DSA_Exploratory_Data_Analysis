# Code for plot3.R -> -> Code file for the third part of the EDA Assignment
...
# plot3  -> Create & place the generated PNG plot in the current working directory with the required dimensions
